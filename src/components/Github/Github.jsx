...
function Github() {
  ...
  return (
    ...
    hover:border-pink-500 hover:shadow-pink-500/50 hover:scale-105 
        ...
        <h1 className=" text-pink-400 font-bold text-5xl  ml-auto pr-10">
          {" "}
          Hello! Visitors{" "}
        </h1>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 ">
        {repos.map((repo) => (
          <div
            key={repo.id}
            className="bg-black text-gray-700 hover:text-white hover:bg-gradient-to-r hover:from-orange-500 hover:to-pink-500 hover:scale-105 hover:shadow-lg p-4 rounded shadow"
          >
